...
/**
 * Change rout to previus.
 */
zz.routers.services.BaseClientRouter.prototype.setPreviousFragment = function( ){

	if( this.historyStack_.length){
 ...
 * Get history stack.
 */
zz.routers.services.BaseClientRouter.prototype.getHistoryStack = function( ){
